...
def content_loss(content_weight, content_current, content_original):
    ...
    F_l=tf.reshape(content_current,[shapes[3],shapes[1]*shapes[2]])
    P_l=tf.reshape(content_original,[shapes[3],shapes[1]*shapes[2]])
...
def gram_matrix(features, normalize = True):
    ...
    gram=tf.matmul(F_l,F_l,transpose_a = True)
