...
class CaptioningRNN(object):
    ...
    def __init__(self, word_to_idx, input_dim=512, wordvec_dim=128,
        ...
        vocab_size = len(word_to_idx)       # V=1004
        ...
        self.params['Wx'] = np.random.randn(wordvec_dim, dim_mul * hidden_dim)  # rnn:[W,H]
        self.params['Wx'] /= np.sqrt(wordvec_dim)
        self.params['Wh'] = np.random.randn(hidden_dim, dim_mul * hidden_dim)   # rnn:[H,H]
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type=='rnn':
            ...
            hidden,lstm_cache=lstm_forward(word_vectors,imf2hid,Wx,Wh,b)    #[N,T,H]
